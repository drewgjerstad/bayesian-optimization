...
aiming to optimize). Note that the list below is not exhaustive; there are
additional theoretical motivations but these seem to be the most common,
particularly with respect to the form and properties of the objective.
...
Shields et al. (2021)](graphics/applications/drug-discovery.png){width=450}
...
_molecular metallophotocatalyst formulation discovery_ by Li et al. (2024)](
  graphics/applications/molecule-protein-discovery.png){width=350}
...
_Qualitative Variables_ by Zhang et al. (2020)](
  graphics/applications/materials-design.jpg)
...
_online particle accelerator tuning_ by Kaiser et al. (2024)](
  graphics/applications/engineering-decisions.png){width=500}
